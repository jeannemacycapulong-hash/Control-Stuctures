...
<head>
    ...
    <body>
        <?php
        $coffeeType = $milk = $sweetness = $isCafFree = "";
        $recoMessage = "";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $recoMessage .= ($sweetness == "Extra Sweet") ? " You like it extra sweet." : ($sweetness == "Medium Sweet" ? " You like it medium sweet." : " You prefer unsweetened coffee.");

            $recoMessage .= ($isCafFree == "yes") ? " You prefer caffeine-free." : " You love caffeine!";
        }
        ...
        <section class="coffee-survey">
            ...
            <p>Take our short survey to discover your perfect coffee!</p>
            ...
            <form method="POST" action="index.php">
                ...
                <select name="caffeine_free" id="caffeine_free" required>
                    <option value="yes" <?php if ($isCafFree == 'yes') echo 'selected'; ?>>Yes</option>
                    <option value="no" <?php if ($isCafFree == 'no') echo 'selected'; ?>>No</option>
                </select><br><br>
